...
export function OffersSection() {
  ...
  return (
    <section id="offres" className="relative border-border/60 border-t bg-secondary/30 py-20 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <p className="font-medium text-primary text-sm uppercase tracking-widest">Offres d&apos;emploi</p>
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Offres classiques et missions last minute dans toute la France.
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {loading
            ...
            : jobs.map((job, i) => (
                ...
                >
                  <JobCard job={job} href={`/jobs/${job.id}`} onApply={() => setApplyOpen(true)} />
                </motion.div>
              ))}
        </div>
        ...
        <div className="mt-10 text-center">
          <Button
            ...
            variant="outline"
            size="lg"
            className="rounded-[16px] border-border text-foreground hover:bg-secondary"
          >
