...
export function DataTable({
  ...
  const [_transactionsData, _setTransactionsData] = React.useState(initialTransactionsData);
  ...
  useEffect(() => {
    console.log("Données initiales reçues dans DataTable :", initialTransactionsData);
