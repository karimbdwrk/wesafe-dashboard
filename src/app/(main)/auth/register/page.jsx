        ...
        <div className="w-full max-w-md space-y-10 py-24 lg:py-32">
          ...
          <div className="space-y-4 rounded-xl border border-border bg-card p-6 text-center">
            ...
            <div className="space-y-2">
              <h2 className="font-semibold text-foreground text-lg">Inscription via l&apos;application</h2>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Les inscriptions se font exclusivement depuis l&apos;application mobile WeSafe. Téléchargez-la
                gratuitement sur iOS ou Android pour créer votre compte.
              </p>
            </div>
            <div className="flex flex-col gap-2 sm:flex-row sm:justify-center">
              <Button asChild className="gap-2 bg-black text-white hover:bg-zinc-800">
          ...
          <div className="relative select-none" aria-hidden="true">
            <div className="pointer-events-none space-y-4 blur-sm">
              <div className="space-y-4 text-center">
                <div className="font-medium tracking-tight">Register</div>
                <div className="mx-auto max-w-xl text-muted-foreground">Fill in your details below.</div>
              </div>
