			...
			<section className='border-b border-border bg-primary py-20 mt-14'>
				<div className='mx-auto max-w-4xl px-6 text-center'>
					...
					<p className='text-primary-foreground/75 text-lg leading-relaxed max-w-2xl mx-auto'>
						Les entreprises choisissent leur formule. Les candidats
						accèdent à toutes les fonctionnalités{" "}
			...
			<div className='mx-auto max-w-6xl px-6 py-16 space-y-20'>
				...
				<section className='grid grid-cols-1 md:grid-cols-2 gap-6'>
					<div className='rounded-2xl border border-border bg-card p-8 flex flex-col gap-4'>
						...
						<div>
							<h2 className='font-(family-name:--font-heading) text-xl font-bold text-foreground mb-1'>
								Candidats
							</h2>
							...
							<p className='text-muted-foreground text-sm leading-6'>
								WeSafe est entièrement gratuit pour les agents
								et professionnels de la sécurité. Créez votre
								profil, déposez vos documents, postulez aux
								offres et signez vos contrats — sans jamais
								payer.
							</p>
						</div>
					...
					<div className='rounded-2xl border border-border bg-card p-8 flex flex-col gap-4'>
						...
						<div>
							...
							<p className='text-muted-foreground text-sm leading-6'>
								Les entreprises bénéficient d'un accès de base
								gratuit et peuvent upgrader pour accéder aux
								outils avancés : annonces Last Minute,
								génération de contrats, statistiques et support
								dédié.
							</p>
						</div>
						<ul className='space-y-2 mt-2'>
				...
				<section>
					<div className='text-center mb-10'>
						<h2 className='font-(family-name:--font-heading) text-3xl font-bold text-foreground mb-2'>
							Formules Entreprises
						</h2>
						<p className='text-muted-foreground'>
							Tous les prix sont TTC. Paiement sécurisé par
							Stripe.
						</p>
					</div>
				...
				<section>
					<div className='text-center mb-8'>
						<h2 className='font-(family-name:--font-heading) text-2xl font-bold text-foreground mb-2'>
							Options supplémentaires
						</h2>
						<p className='text-muted-foreground text-sm'>
							Disponibles en complément de votre abonnement
						</p>
					</div>
				...
				{/* Bandeau CGV */}
				<section className='rounded-2xl border border-amber-200 bg-amber-50 px-8 py-6 flex flex-col sm:flex-row items-start sm:items-center gap-4'>
					<div className='flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-amber-100'>
						<Info className='h-5 w-5 text-amber-600' />
					</div>
					<div className='flex-1'>
						<p className='font-semibold text-amber-900 mb-0.5'>
							Conditions tarifaires complètes
						</p>
						<p className='text-sm text-amber-800 leading-6'>
							Les prix affichés sur cette page sont donnés à titre
							indicatif et susceptibles d&apos;évoluer. Les
							conditions contractuelles précises (TVA, modalités
							de paiement, remboursement, résiliation) sont
							définies dans nos{" "}
							<Link
				...
				<section>
					<div className='text-center mb-8'>
						<h2 className='font-(family-name:--font-heading) text-2xl font-bold text-foreground'>
				...
				<section className='rounded-2xl border border-border bg-card p-10 text-center'>
					...
					<p className='text-muted-foreground max-w-md mx-auto mb-7 text-sm leading-6'>
						Créez votre compte gratuitement et accédez immédiatement
						à la plateforme. Aucune carte bancaire requise pour
						commencer.
					</p>
